  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1
          className='text-4xl text-center leading-none font-heading font-medium flex flex-col md:text-7xl md:text-left'
        >
          <span
            className='text-blue'
          >
      ...
      <div
        className='flex gap-5 items-stretch flex-col md:flex-row'
      >
        <div
          className='flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6'
        >
          <div
          ...
          >
            ...
            <span
              className='text-purple font-semibold text-xs flex items-center gap-2'
            >
              <Radio
                className='size-5'
              />
